...
parser.add_argument("--result_dir", type=str, help='path of checkpoint for pretrained model')
...
trainFlowBackWarp      = model.backWarp(512, 288, device)
trainFlowBackWarp      = trainFlowBackWarp.to(device)
validationFlowBackWarp = model.backWarp(512, 288, device)
...
def validate():
    ...
    flag = 1
    with torch.no_grad():
        for validationIndex, (validationData, validationFrameIndex, datapath) in enumerate(validationloader, 0):
